        ...
        <div className="container mx-auto grid md:grid-cols-2 items-center justify-center md:justify-between">
          <div className="about-info">
            ...
            <p className="pb-5">
              ...
              create advanced applications which are fit for purpose,
              functionally correct and meets the user's precise needs
            </p>
            <p className="pb-5">
            ...
            <p className="pb-5">
              ...
              create a highly interactive user experience. On a personal level
              I'm is loaded with energy and passion
            </p>
            <p>
              Right now i would like to join a company where there is a culture
              of encourangement,respect and teamwork
            </p>
          </div>
