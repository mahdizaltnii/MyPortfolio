...
const Projects = ({ darkMode }) => {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <section
        className="bg-white dark:bg-gray-900 text-gray-800 dark:text-white px-5 py-32 font-mono"
        id="projects"
      >
          ...
          {projects.map((project, i) => {
            return (
              <div className="relative" key={i}>
                <img src={project.img} alt={project.title} className="object-cover h-64 w-full" />
